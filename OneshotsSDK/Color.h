...
public:
	...
	static Color Red() { return Color(255, 0, 0, 155); }
	static Color Green() { return Color(0, 255, 0, 155); }
	static Color Blue() { return Color(0, 0, 255, 155); }
	static Color LightBlue() { return Color(100, 100, 255, 155); }
	static Color Grey() { return Color(128, 128, 128, 155); }
	static Color DarkGrey() { return Color(45, 45, 45, 155); }
	static Color Black() { return Color(0, 0, 0, 155); }
	static Color White() { return Color(255, 255, 255, 155); }
	static Color Purple() { return Color(220, 0, 220, 155); }
	static Color Yellow() { return Color(255, 255, 0, 155); }
	static Color Orange() { return Color(255, 128, 0, 155); }
	static Color Cyan() { return Color(0, 178, 178, 155); }
